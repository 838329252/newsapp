...
public class BindItemTwo {
    ...
    private int news_id;
    public BindItemTwo(int layoutType, LinearLayout container, String title, List<Picture> pictureList, String column,boolean itemBottomVisibility,int id){
    ...
    private void addView(){
        ...
        Glide.with(getContext()).load(pictureList.get(0).getPictureUrl()).into(pictureLeft);
        Glide.with(getContext()).load(pictureList.get(1).getPictureUrl()).into(pictureRight);
